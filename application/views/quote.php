		...
		<div class="col-lg-10 col-centered">
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<p>
						If you are looking at our work, reading this copy, we are already starting to connect. And isn’t that what a good client/agency relationship should do? Become apart of the team.
					</p>
				</div>
			</div>
		</div>
