<div class="quote">
		...
		<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 col-centered">
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<p>
						Now that you've gone through our work, and are reading this page, we have already begun to connect. Isn't that what a client agency relationship should be able to achieve ? Meet us and be apart of the team!
					</p>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 col-centered quote-overview">
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					<p>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 r-s">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 ">
					...
					<!-- <div class="row">
						<div class="col-lg-6">
							<h2>Sales</h2>
							<p>
								<a href="mainto:quote@codebibber.com">quote@codebibber.com</a>
							</p>
							<p>
								<a href="mainto:sales@codebibber.com">sales@codebibber.com</a>
							</p>
						</div>
						<div class="col-lg-6">
							<h2>Company</h2>
