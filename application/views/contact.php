<div class="contact quote">
	<div class="map">
		<div class="row">
			<div class="col-lg-12" id="map_canvas" style="width:100%; height:250px;">
...
<script type="text/javascript">
  	function initialize() {
	    var position = new google.maps.LatLng(28.5324104,77.2060846);
	    var image = '<?php echo base_url(); ?>images/map-logo.png';
	    var myOptions = {
			zoom: 18,
			center: position,
			scrollwheel: false,
	    ...
	    var contentString = '<strong>CodeBibber</strong><br> A-281 Block A, Shivalik, Malviya Nagar New Delhi 110017, India <br>+91-9711575088 <br>you@codebibber.com';
